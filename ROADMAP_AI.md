...
| 2026-07-14 | Sifter UI polish                 | `apps/web/src/components/sifter/*`, `apps/web/src/app/styles.css`, `packages/ui/src/components/sheet.tsx` | Landing uses a restrained app-blue gradient; conversation is neutral; sheets animate smoothly. |
