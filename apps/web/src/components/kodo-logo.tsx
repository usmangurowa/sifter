...
interface KodoLogoProps extends React.SVGProps<SVGSVGElement> {
  /**
...
/**
 * Kodo logo component - renders as inline SVG for crisp scaling and styling.
 *
 * @example
 * ```tsx
 * <KodoLogo size="lg" className="text-primary" />
 * ```
 */
export const KodoLogo = ({
  size = "md",
  className,
  ...props
}: KodoLogoProps) => {
