...
/**
 * Synchronize user identity with Sentry only.
 * Use this if you don't need PostHog integration.
 *
 * @deprecated Use syncUserIdentity with both Sentry and PostHog instead
 */
export const syncSentryUser = (
  ...
  try {
    ...
    console.error("[Sentry] Failed to sync user identity:", error);
    return currentIdentifiedId;
  }
};

// Keep old exports as aliases for backwards compatibility
/** @deprecated Use SentryUserSetter instead */
export type SentryClient = SentryUserSetter;
