  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          <SunIcon className="auto:scale-0 scale-100 dark:scale-0" />
          <MoonIcon className="auto:scale-0 scale-0 dark:scale-100" />
          <DesktopIcon className="auto:scale-100 scale-0" />
